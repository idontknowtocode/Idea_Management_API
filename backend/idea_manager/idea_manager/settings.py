"""
Django settings for idea_manager project.
...
SECRET_KEY = 'django-insecure-v9^$8n73@a-f7xp1(@k**k*1oahr=n@at#hgz6-3axig+)*zdd'
...
ROOT_URLCONF = 'idea_manager.urls'
...
WSGI_APPLICATION = 'idea_manager.wsgi.application'
